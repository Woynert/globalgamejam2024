...
var AUDIO_PATH = {
	AUDIO.LOOP_CIRCUS_AMBIENT_1: "res://resource_remote/audio/music/Circus Ambient 1.mp3",
	AUDIO.LOOP_CIRCUS_AMBIENT_CUERDA: "res://resource_remote/audio/music/Escena Circus Cuerda.mp3",
	AUDIO.LOOP_CIRCUS_AMBIENT_INTRO: "res://resource_remote/audio/music/Escena Circus Intro.mp3",
	AUDIO.LOOP_CIRCUS_AMBIENT_PLAYFUL: "res://resource_remote/audio/music/Escena Circus Playful.mp3",
	AUDIO.LOOP_CIRCUS_AMBIENT_TIBURONES: "res://resource_remote/audio/music/Escena Circus Tiburones.mp3",
	AUDIO.LOOP_CIRCUS_AMBIENT_TROMPETA: "res://resource_remote/audio/music/Escena Trompeta Circus.mp3",
	AUDIO.LOOP_BAD_ENDING: "res://resource_remote/audio/music/Final Triste Pobreza.mp3",
	AUDIO.LOOP_BAD_ENDING_POLO: "res://resource_remote/audio/music/Final Cambio Profesion.mp3",
	AUDIO.LOOP_GOOD_ENDING: "res://resource_remote/audio/music/Final Willy Boat completo.mp3",
